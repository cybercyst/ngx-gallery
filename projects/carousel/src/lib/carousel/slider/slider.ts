...
export class Slider implements AfterViewInit, OnInit, OnChanges, OnDestroy {
  ...
  @Output() action: EventEmitter<CarouselActionEvent> = new EventEmitter<CarouselActionEvent>();
  @Output() scrollIndexChange: EventEmitter<CarouselState> = new EventEmitter<CarouselState>();
  ...
  @ViewChildren(CarouselPageTemplate) items = new QueryList<CarouselPageTemplate>();
  ...
  ngAfterViewInit(): void {
    ...
    this.items.changes.pipe(
      ...
      tap(() => {
        ...
        this.items.toArray().map((item: CarouselPageTemplate) => {
